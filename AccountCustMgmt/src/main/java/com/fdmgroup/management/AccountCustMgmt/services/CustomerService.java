...
public class CustomerService {
    ...
    public Customer createCustomer(String name, String postalCode, String streetNumber, String customerType) {
        Geolocation geoResp = geoClient.getLocation(postalCode);
    ...
    public void setAccount(long customerId, long accountId) {
        ...
        Account accountReceieved = accountRepo.findById(accountId).get();
